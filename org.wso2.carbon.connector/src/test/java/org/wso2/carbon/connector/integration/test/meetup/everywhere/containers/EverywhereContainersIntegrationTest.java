...
public class EverywhereContainersIntegrationTest extends MeetupConnectorIntegrationTest {
    ...
    public void testGetContainerRequiredParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_getContainer_mandatory.txt";
    ...
    public void testGetContainerWithNegativeParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_getContainer_negative.txt";
        String methodName = "everywhere_containers_get_container";
    ...
    public void testGetContainerWithOptionalParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_getContainer_optional.txt";
        String methodName = "everywhere_containers_get_container";
    ...
    public void testGetContainerByIdWithNegativeParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_getContainerById_negative.txt";
    ...
    @Test(enabled = true, groups = { "wso2.esb" }, description = "meetup {getContainerById} integration test")
    public void testGetContainerByIdWithOptionalParameters() throws Exception {

        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_getContainerById_optional.txt";
        String methodName = "everywhere_containers_get_container_by_id";
    ...
    public void testGetContainerAlertByIdWithNegativeParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_getContainerAlert_negative.txt";
    ...
    @Test(enabled = true, groups = { "wso2.esb" }, description = "meetup {getContainerIdAlert} integration test")
    public void testGetContainerAlertByIdWithOptionalParameters() throws Exception {

        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_getContainerAlert_optional.txt";
        String methodName = "everywhere_containers_get_container_alerts";
    ...
    public void testPostContainerRequiredParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_postContainer_mandatory.txt";
    ...
    public void testPostContainerWithNegativeParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_postContainer_negative.txt";
        String methodName = "everywhere_containers_post_container";
    ...
    public void testPostContainerWithOptionalParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_postContainer_optional.txt";
        String methodName = "everywhere_containers_post_container";
    ...
    public void testPostContainerByIdWithNegativeParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_postContainerById_negative.txt";
    ...
    public void testPostContainerByIdWithOptionalParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_postContainerById_optional.txt";
        String methodName = "everywhere_containers_post_container_by_id";
    ...
    public void testPostContainerAlertByIdWithNegativeParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_postContainerAlert_negative.txt";
    ...
    public void testPostContainerAlertByIdWithOptionalParameters() throws Exception {
        ...
        String jsonRequestFilePath = pathToRequestsDirectory + "everywhere_container_postContainerAlert_optional.txt";
        String methodName = "everywhere_containers_post_container_alerts";
