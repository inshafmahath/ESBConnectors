...
public class BoardsIntegrationTest extends MeetupConnectorIntegrationTest {
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Boards's getDiscussionBoards operation integration test for Mandatory fields")
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Board's getDiscussionBoards operation integration test for negative scenario.")
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Board's getDiscussions operation integration test for Mandatory fields")
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Board's getDiscussions operation integration test for negative scenario")
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Board's getDiscussionPosts operation integration test for Mandatory fields")
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Board's getDiscussionPosts operation integration test for negative scenario")
