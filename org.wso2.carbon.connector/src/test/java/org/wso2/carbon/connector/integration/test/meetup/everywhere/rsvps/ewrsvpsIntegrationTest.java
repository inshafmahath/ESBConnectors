...
public class ewrsvpsIntegrationTest extends MeetupConnectorIntegrationTest {
    ...
    @Test(enabled = true, groups = {"wso2.esb"}, description = "meetup {getew_rsvps} integration test")
    ...
    @Test(enabled = true, groups = {"wso2.esb"}, description = "meetup {getew_rsvps}  integration test for negative scenario.")
    ...
    @Test(enabled = false, groups = {"wso2.esb"}, description = "meetup {delete_ewrsvps} integration test")
    ...
    @Test(enabled = false, groups = {"wso2.esb"}, description = "meetup {delete_ewrsvps}  integration test for negative scenario.")
...
// ................................ optional parameters test for create_rsvps  ......................
    ...
    @Test(enabled = false, groups = {"wso2.esb"}, description = "meetup {create_rsvps}  integration test for negative scenario.")
    ...
    @Test(enabled = true, groups = {"wso2.esb"}, description = "meetup {create_rsvps} integration test")
    ...
    @Test(enabled = true, groups = {"wso2.esb"}, description = "meetup {getew_rsvps_byid}  integration test for negative scenario.")
