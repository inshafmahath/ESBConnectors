...
public class BatchIntegrationTest extends MeetupConnectorIntegrationTest {
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Meetup batchRequests integration test for Mandatory fields.")
	 ...
	 *             if test fails.
	 */
	@Test(enabled = true, groups = { "wso2.esb" }, description = "Meetup batchRequests integration test for negative scenario.")
